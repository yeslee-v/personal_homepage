...
export const projectsDetail: ProjectsDetailProps[] = [
  ...
  },
  {
    ...
    title: "대학 정보 관리 서비스",
    description: [
      "업무 담당자 관리 자동화를 위해 시작한 프로젝트로 프론트엔드 3명, 백엔드 2명이 작업했습니다.",
      "개발 환경 구축부터 DB 설계, RESTful API 구현 등 처음부터 끝까지 프로젝트의 전 과정을 진행했습니다.",
      "Query Builder와 TypeORM를 비교하면서 상황에 따라 어떤 도구가 적합한지 생각할 수 있었습니다.",
    ],
    githubUrl: "",
  },
  {
